...
public class HTristateCheckBox extends JCheckBox {
    ...
    public static void main(String args[]) throws Exception {
        ...
        contentPane.add(new HTristateCheckBox("i am selected", SELECTED));
        contentPane.add(new HTristateCheckBox("i am not specified", NOTSPECIFIED));
        contentPane.add(new HTristateCheckBox("i am deselected", DESELECTED));
