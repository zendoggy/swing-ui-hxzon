...
public class DrawStringPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        java.awt.geom.Rectangle2D.Double double1 = new java.awt.geom.Rectangle2D.Double(insets.left, insets.top, dimension.getWidth() - (double) insets.left - (double) insets.right,
