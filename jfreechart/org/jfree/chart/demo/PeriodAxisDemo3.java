...
public class PeriodAxisDemo3 extends ApplicationFrame {
    ...
    private static JFreeChart createChart(IntervalXYDataset intervalxydataset) {
        ...
        aperiodaxislabelinfo[1] = new PeriodAxisLabelInfo(org.jfree.data.time.Day.class, new SimpleDateFormat("E"), new RectangleInsets(2D, 2D, 2D, 2D), new Font("SansSerif", 1, 10), Color.blue,
