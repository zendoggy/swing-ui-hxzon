...
public class PopulationChartDemo1 extends ApplicationFrame {
    ...
    public PopulationChartDemo1(String s) {
        ...
        org.jfree.chart.JFreeChart jfreechart = ChartFactory.createStackedBarChart("Population Chart Demo", "Age Group", "Population (millions)", keyedvalues2ddataset, PlotOrientation.HORIZONTAL,
                true, true, false);
