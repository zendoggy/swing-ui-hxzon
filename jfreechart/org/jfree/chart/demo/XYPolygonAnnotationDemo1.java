...
public class XYPolygonAnnotationDemo1 extends ApplicationFrame {
    ...
    public static XYDataset createDataset() {
        ...
        double ad3[] = { 2.1000000000000001D, 2.2000000000000002D, 2.3999999999999999D, 2.7000000000000002D, 3.2000000000000002D };
    ...
    private static JFreeChart createChart(XYDataset xydataset) {
        ...
        XYPolygonAnnotation xypolygonannotation = new XYPolygonAnnotation(new double[] { 2D, 5D, 2.5D, 8D, 3D, 5D, 2.5D, 2D }, null, null, new Color(200, 200, 255, 100));
