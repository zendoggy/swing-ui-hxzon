...
//        });
    ...
    private PropertyTable createTable() {
        ...
        final ConverterContext doubleEditConverterContext = new ConverterContext("Editor");
        ObjectConverterManager.registerConverter(Double.class, editorConverter, doubleEditConverterContext);
        CellEditorManager.registerEditor(Double.class, new CellEditorFactory() {
            public CellEditor create() {
                DoubleCellEditor editor = new DoubleCellEditor();
                editor.setConverterContext(doubleEditConverterContext);
                return editor;
            }
        });
