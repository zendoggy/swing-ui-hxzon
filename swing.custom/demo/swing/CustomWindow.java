...
public class CustomWindow extends JFrame implements MouseListener, MouseMotionListener, ComponentListener, ActionListener {
	...
	private void initIcon() {
		northwestIcon = new ImageIcon(CustomWindow.class.getResource("northwest.png"));
		northeastIcon = new ImageIcon(CustomWindow.class.getResource("northeast.png"));
		northIcon = new ImageIcon(CustomWindow.class.getResource("north.png"));
		southwestIcon = new ImageIcon(CustomWindow.class.getResource("southwest.png"));
		southeastIcon = new ImageIcon(CustomWindow.class.getResource("southeast.png"));
		southIcon = new ImageIcon(CustomWindow.class.getResource("south.png"));
		westIcon = new ImageIcon(CustomWindow.class.getResource("west.png"));
		eastIcon = new ImageIcon(CustomWindow.class.getResource("east.png"));
		//
	...
	private class ContentPane extends JComponent {
		...
		protected void paintComponent(Graphics g) {
			...
			if (appIcon != null) {
				appIcon.paintIcon(contentPane, g, getWidth() / 2 - fm.stringWidth(title) / 2 - appIcon.getIconWidth() - 10, northIcon.getIconHeight() / 2 - appIcon.getIconHeight() / 2);
			}
		}
	}
...
//			int h = contentPane.getHeight();
	...
	public void componentResized(ComponentEvent e) {
		buttonPane.setBounds(contentPane.getWidth() - northeastIcon.getIconWidth() - closeIcon.getIconWidth(), 0, closeIcon.getIconWidth(), closeIcon.getIconHeight());
		...
		try {
			SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					...
					win.setIcon(new ImageIcon(CustomWindow.class.getResource("title.png")));
					win.setVisible(true);
				}
			});
		} catch (Exception e) {
