...
public class DifferenceChartDemo2 extends ApplicationFrame {
    ...
    private static JFreeChart createChart(XYDataset xydataset) {
        ...
        IntervalMarker intervalmarker = new IntervalMarker((new Day(28, 3, 2004)).getFirstMillisecond(), (new Day(30, 10, 2004)).getFirstMillisecond(), gradientpaint, new BasicStroke(2.0F), null,
                null, 1.0F);
