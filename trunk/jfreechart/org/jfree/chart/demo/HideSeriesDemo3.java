...
public class HideSeriesDemo3 extends ApplicationFrame {
    ...
    static class DemoPanel extends JPanel implements ActionListener {
        ...
        private XYZDataset createSampleDataset() {
            ...
            double ad[] = { 2.1000000000000001D, 2.2999999999999998D, 2.2999999999999998D };
            double ad1[] = { 14.1D, 11.1D, 10D };
            double ad2[] = { 2.3999999999999999D, 2.7000000000000002D, 2.7000000000000002D };
            double ad3[][] = { ad, ad1, ad2 };
            defaultxyzdataset.addSeries("Series 1", ad3);
            ad = (new double[] { 2.2000000000000002D, 2.2000000000000002D, 1.8D });
            ad1 = (new double[] { 14.1D, 11.1D, 10D });
            ad2 = (new double[] { 2.2000000000000002D, 2.2000000000000002D, 2.2000000000000002D });
            ad3 = (new double[][] { ad, ad1, ad2 });
            defaultxyzdataset.addSeries("Series 2", ad3);
            ad = (new double[] { 1.8D, 1.8999999999999999D, 2.2999999999999998D, 3.7999999999999998D });
            ad1 = (new double[] { 5.4000000000000004D, 4.0999999999999996D, 4.0999999999999996D, 25D });
            ad2 = (new double[] { 2.1000000000000001D, 2.2000000000000002D, 1.6000000000000001D, 4D });
            ad3 = (new double[][] { ad, ad1, ad2 });
