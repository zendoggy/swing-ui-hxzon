...
public class PeriodAxisDemo2 extends ApplicationFrame {
    ...
    private static JFreeChart createChart(XYDataset xydataset) {
        ...
        aperiodaxislabelinfo[1] = new PeriodAxisLabelInfo(org.jfree.data.time.Month.class, new SimpleDateFormat("MMM"), new RectangleInsets(2D, 2D, 2D, 2D), new Font("SansSerif", 1, 10), Color.blue,
