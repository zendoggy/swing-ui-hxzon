package demo;
/*
 * @(#)LuceneQuickFilterListDemo.java 5/1/2009
 *
...
import com.jidesoft.lucene.LuceneQuickListFilterField;
 ...
 */
public class LuceneQuickFilterListDemo extends AbstractDemo {

    public LuceneQuickFilterListDemo() {
    }

    public String getName() {
        return "LuceneFilterListModel Demo";
    }
    ...
    public Component getDemoPanel() {
        ...
        final QuickListFilterField field = new LuceneQuickListFilterField(listModel);
        field.setHintText("Type here to filter fonts");
        quickSearchPanel.add(field);
        quickSearchPanel.setBorder(new JideTitledBorder(new PartialEtchedBorder(PartialEtchedBorder.LOWERED, PartialSide.NORTH), "LuceneQuickListFilterField", JideTitledBorder.LEADING, JideTitledBorder.ABOVE_TOP));
...
//        panel.add(textField, BorderLayout.AFTER_LAST_LINE);
    ...
    static public void main(String[] s) {
        ...
        showAsFrame(new LuceneQuickFilterListDemo());
    }
}