...
public class JDateChooser extends JPanel implements ActionListener, PropertyChangeListener {
     ...
     */
    public JDateChooser(String datePattern, char placeholder) {
        this(null, null, datePattern, new JTextFieldDateEditor(datePattern, placeholder));
    }
    ...
    public JDateChooser(JCalendar jcal, Date date, String dateFormatString, IDateEditor dateEditor) {
        ...
        URL iconURL = getClass().getResource("/com/toedter/calendar/images/calendar.gif");
    ...
    public static void main(String[] s) {
        ...
        frame.getContentPane().add(new JDateChooser("yyyy/MM/dd", '_'));
        frame.pack();
